...
TEST_CASE("virt_x2apic: reset values")
{
    ...
    g_msrs[msrs_n::ia32_x2apic_svr::addr] = lapic_n::svr::reset_value;
...
TEST_CASE("virt_x2apic: tpr")
{
    ...
    auto phys_x2apic = std::make_unique<eapis::intel_x64::phys_x2apic>();
    auto vapic = eapis::intel_x64::virt_x2apic(hve.get(), phys_x2apic.get());
    auto addr = ia32_x2apic_tpr::addr;

    vapic.write_register(addr, 0xFFFFFFFF00000000U);
    CHECK(vapic.read_register(addr) ==  0x0U);
...
TEST_CASE("virt_x2apic: icr")
{
    ...
    auto phys_x2apic = std::make_unique<eapis::intel_x64::phys_x2apic>();
    auto vapic = eapis::intel_x64::virt_x2apic(hve.get(), phys_x2apic.get());
    auto addr = ia32_x2apic_icr::addr;
...
TEST_CASE("virt_x2apic: self_ipi")
{
    ...
    CHECK(vapic.read_register(ia32_x2apic_self_ipi::addr) == 0xFEU);
}
...
TEST_CASE("virt_x2apic: svr")
{
    ...
    auto phys_x2apic = std::make_unique<eapis::intel_x64::phys_x2apic>();
    auto vapic = eapis::intel_x64::virt_x2apic(hve.get(), phys_x2apic.get());
    auto addr = ia32_x2apic_svr::addr;
