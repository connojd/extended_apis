...
public:
    ...
    /// Handle xAPIC read monitor trap exit
    ///
    /// @expects
    /// @ensures
    ///
    ...
    bool handle_apic_access(gsl::not_null<vmcs_t *> vmcs);
...
private:
    ...
    bool m_need_write_mtf;
    bool m_need_read_mtf;
    uint64_t m_virt_base_msr;
    uint64_t m_phys_base_msr;
    const uint64_t m_orig_base_msr;
    lapic_register::offset_t m_access_offset;
    ...
    std::unique_ptr<gsl::byte[]> m_apic_access;
