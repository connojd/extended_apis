...
ioapic::value_t
phys_ioapic::read_register(ioapic::offset_t offset)
{
    expects(ioapic::is_readable(offset));
...
void
phys_ioapic::write_register(ioapic::offset_t offset, ioapic::value_t val)
{
    expects(ioapic::is_writable(offset));
