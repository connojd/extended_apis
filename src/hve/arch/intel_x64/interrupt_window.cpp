...
{ vmcs_n::primary_processor_based_vm_execution_controls::interrupt_window_exiting::enable(); }
...
interrupt_window::dump_log()
{
    bfdebug_transaction(0, [&](std::string * msg) {
        bfdebug_lnbr(0, msg);
        bfdebug_info(0, "Interrupt-window exits", msg);
        bfdebug_subnhex(0, "count", m_count, msg);
        bfdebug_brk2(0, msg);
        bfdebug_lnbr(0, msg);
    });
}
