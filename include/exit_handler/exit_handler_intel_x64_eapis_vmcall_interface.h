...
//    eapis_cat__msr = 0x3000,
    ...
    eapis_cat__cr3_store = 0xD000,
    eapis_cat__cr3_load = 0xE000,
...
//    eapis_fun__disable_msr_bitmap = 0x2,
    ...
    eapis_fun__trap_on_wbinvd = 0x1,
    eapis_fun__pass_through_on_wbinvd = 0x2,

    eapis_fun__trap_on_rdpmc = 0x1,
    eapis_fun__pass_through_on_rdpmc = 0x2,

    eapis_fun__trap_on_rdtsc = 0x1,
    ...
    eapis_fun__trap_on_cr3_load = 0x1,
    eapis_fun__pass_through_on_cr3_load = 0x2,
    ...
    eapis_fun__trap_on_gva = 0x3,
    eapis_fun__trap_on_gpa = 0x4,
    eapis_fun__pass_through_on_gva = 0x5,
