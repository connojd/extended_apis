...
public:
    ...
    using msr_t = ::intel_x64::vmcs::value_type;                                ///< MSR Type
    ...
    using rdmsr_handler_delegate_t =                                            ///< RDMSR Handler Type
        delegate<bool(gsl::not_null<bfvmm::intel_x64::vmcs *>, info_t &)>;

    using wrmsr_handler_delegate_t =
        delegate<bool(gsl::not_null<bfvmm::intel_x64::vmcs *>, info_t &)>;      ///< WRMSR Handler Type
...
public:
    ...
    /// @param d the handler to call when an exit at the address occurs
    ///
    ...
    /// Example:
    /// @code
    /// this->enable_rdmsr_log();
    /// @endcode
    ///
    /// @expects
    /// @ensures
    ///
    void enable_rdmsr_log();

    /// Disable RDMSR Log
    ///
    /// Example:
    /// @code
    /// this->disable_rdmsr_log();
    /// @endcode
    ///
    /// @expects
    /// @ensures
    ///
    void disable_rdmsr_log();
...
public:
    ...
    /// Example:
    /// @code
    /// this->enable_wrmsr_log();
    /// @endcode
    ///
    /// @expects
    /// @ensures
    ///
    void enable_wrmsr_log();

    /// Disable WRMSR Log
    ///
    /// Example:
    /// @code
    /// this->disable_wrmsr_log();
    /// @endcode
    ///
    /// @expects
    /// @ensures
    ///
    void disable_wrmsr_log();
...
private:
    ...
    bool m_rdmsr_log_enabled{false};
    bool m_wrmsr_log_enabled{false};
